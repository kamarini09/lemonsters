...
function start(){
    ...
    document.querySelector("#life_board").classList.add("live3");

    document.querySelector("#score_board").classList.value="";
    document.querySelector("#score_board").classList.add("point0");
    showTitle();
...
function showTitle(){
    ...
    document.querySelector("#rules_button").addEventListener("click",showInstructions);
...
function showInstructions(){
    ...
    document.querySelector("#instructions").classList.remove("hidden");
     document.querySelector("#play2_button").addEventListener("click",startGame);
}
...
function startGame() {
   ...
   document.querySelector("#apple_container").classList.add("rotation2", "pos3");
   ...
   document.querySelector("#apple_container").addEventListener("animationiteration", appleAgain);
    ...
    document.querySelector("#orange_container").classList.add("pattern", "pos12");
    ...
    startTimer();
    let birdsAudio = document.querySelector('#birds');
      birdsAudio.play();
...
function LemonHit(){
    ...
    document.querySelector("#lemon").classList.add("rotation");
...
function lemonAgain() {
    ...
    let randomPosition = generateRandomNumber(12);
...
function watermellonHit(){
    ...
    let ahhnejAudio = document.querySelector('#ahhnej');
    ahhnejAudio.play();
    loseLife();
    if(lives===3){
        document.querySelector("#life_board").classList.value="";
...
function appleAgain() {
    ...
    let randomPosition = generateRandomNumber(8);
    document.querySelector("#apple_container").classList.add("rotation2", "pos" +randomPosition);
...
function endOfTheGame()   {
    ...
    document.querySelector("#lemon_container").removeEventListener("click", LemonHit);
    document.querySelector("#watermellon_container").removeEventListener("click", watermellonHit);
    document.querySelector("#apple_container").removeEventListener("click", appleHit);
    document.querySelector("#orange_container").removeEventListener("click", orangeHit);

    document.querySelector("#lemon_container").removeEventListener("animationiteration", lemonAgain);
    document.querySelector("#watermellon_container").removeEventListener("animationiteration", watermellonAgain);
    document.querySelector("#apple_container").removeEventListener("animationiteration", appleAgain);
    document.querySelector("#orange_container").removeEventListener("animationiteration", orangeAgain);
...
function gameOver() {
    ...
    document.querySelector("#play_again_game_over").addEventListener("click", startGame);
    document.querySelector("#exit_game_over").addEventListener("click", start);
    // ahhnejAudio.pause();
    let nejAudio = document.querySelector('#nej');
    nejAudio.play();
...
function youWon() {
    ...
    document.querySelector("#play_again_you_won").addEventListener("click", startGame);
    document.querySelector("#exit_you_won").addEventListener("click", start);
   
    let yeeeyAudio = document.querySelector('#yeeey');
      yeeeyAudio.play();
